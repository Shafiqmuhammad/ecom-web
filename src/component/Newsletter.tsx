    ...
    <Wrapper>
      <div className="flex w-full justify-center items-center">
        <div className="flex flex-col justify-between items-center  w-full gap-y-5 my-20 relative">
          <h3 className="text-[2rem] font-bold text-green-800">Subscribe Our Newsletter</h3>
          <p className="text-[rem] font-semibold text-green-800">Get the latest information and promo offers directly</p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 w-full">
            ...
            />
            <button className="text-white  bg-[#107125] px-8 py-2">
              Get Started
            </button>
          </div>
