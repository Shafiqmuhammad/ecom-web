        ...
        <section className='flex flex-col gap-y-10 lg:flex-row md:flex-row py-8'>
            ...
            <div className='flex-1'>
                ...
                <p className='leading-7 [&:not(:first-child)]:mt-6 text-justify pr-8'>
                    ...
                    Whether you are looking for workwear basics, cooler-than-cool streetwear, elegant classics, sharp suits, off-duty staples, glamorous eveningwear,
                    adorable kids outfits or seasonal trends from your favourite brands, we have got you covered.
                </p>
                {/* <StartShopping /> */}
