...
import P1 from "/public/assets/feature-removebg-preview.png"
    ...
    <Wrapper>
      <div className="grid grid-cols-2 gap-5">
        <div className="col-span-2 col-start-1 h-full w-full  xl:col-start-2">
          <h3 className="text-[2.5rem] sm:text-[2.75rem] tracking-[0.03em] leading-[3rem] text-green-800">
        ...
        <div className="col-span-2 grid grid-cols-2 gap-5">
          ...
          <div className="col-span-2   xl:col-span-1">
            <div className="flex flex-col h-full w-full items-center justify-center gap-5 sm:flex-row">
              <div className="basis-1/2  w-full flex justify-center shadow-lg px-1 py-3 shadow-green-900 rounded min-w-[170px]">
                <Image
                  src={P1}
                  alt=""
                  width={250}
              ...
              <div className="flex flex-col justify-center items-center gap-5  basis-1/2 ">
                ...
                <button className="w-28 bg-[#107125] p-2 text-sm text-white">
                  See All Products
                </button>
              </div>
            </div>
